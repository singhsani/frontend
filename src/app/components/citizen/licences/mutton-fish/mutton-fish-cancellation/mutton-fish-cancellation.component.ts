...
export class MuttonFishCancellationComponent implements OnInit {
	...
	muttonCancellationForm: FormGroup;
	translateKey: string = 'muttonFishCancelScreen';
	...
	ngOnInit() {
		...
		this.getMuttonFishCancelData();
		this.getLookupData();
		this.muttonCancellationFormControls();
	}

	getMuttonFishCancelData() {
		this.formService.getFormData(this.appId).subscribe(res => {
			this.muttonCancellationForm.patchValue(res);
		});
	}
	...
	muttonCancellationFormControls() {
		this.muttonCancellationForm = this.fb.group({
