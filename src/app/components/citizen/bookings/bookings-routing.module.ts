...
import { ShootingPermissionModule } from './shooting-permission/shooting-permission.module';
...
const routes: Routes = [
	...
	{ path: ManageRoutes.getMainRoute('SHOOTINGPERMISSION'),loadChildren: () => ShootingPermissionModule ,canLoad: [AuthGuard] }
];
