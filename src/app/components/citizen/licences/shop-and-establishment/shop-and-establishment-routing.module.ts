...
const routes: Routes = [
	...
	{ path: ManageRoutes.getMainRoute('SHOP-REN') + '/:id/:apiCode', component: ShopLicNewComponent },
	{ path: ManageRoutes.getMainRoute('SHOP-TRAF') + '/:id/:apiCode', component: ShopLicNewComponent },
];
