...
@Component({
	...
	templateUrl: './property-transfer.component.html',
	styleUrls: ['./property-transfer.component.scss']
})
export class PropertyTransferComponent implements OnInit {
	...
	translateKey: string = 'propertyTransferScreen';
	...
	ngOnInit() {
		...
		this.getLookupData();
		this.propertyTransferFormControls();
	}

	getPropertyExtractData() {
		this.formService.getFormData(this.appId).subscribe(res => {
			this.propertyTransferForm.patchValue(res);
		});
	}
	...
	propertyTransferFormControls() {
		this.propertyTransferForm = this.fb.group({
			id: null,
			uniqueId: null,
			version: null,
			serviceFormId: null,
