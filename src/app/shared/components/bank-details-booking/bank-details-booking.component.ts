...
@Component({
  selector: 'app-bank-details-booking',
  templateUrl: './bank-details-booking.component.html',
  styleUrls: ['./bank-details-booking.component.scss']
})
export class BankDetailsBookingComponent implements OnInit {
  ...
  createFormControls() {
    ...
    this.atithigruhForm.addControl('accountHolderName', new FormControl(null, [Validators.required, Validators.maxLength(50), Validators.minLength(2)]));
