...
@Component({
	selector: 'app-applicant-detail-drainagewater',
	templateUrl: './applicant-detail-drainagewater.component.html',
	styleUrls: ['./applicant-detail-drainagewater.component.scss']
})
export class ApplicantDetailDrainagewaterComponent implements OnInit {
