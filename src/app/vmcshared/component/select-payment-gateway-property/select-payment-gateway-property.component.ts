...
@Component({
  selector: 'select-payment-gateway-property',
  templateUrl: './select-payment-gateway-property.component.html',
  styleUrls: ['./select-payment-gateway-property.component.scss']
})
export class SelectPaymentGatewayPropertyComponent implements OnInit {
