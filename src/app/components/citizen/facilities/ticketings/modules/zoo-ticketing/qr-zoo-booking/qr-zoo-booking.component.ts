...
import { AppService } from 'src/app/core/services/citizen/app-services/app.service';
import { SessionStorageService } from 'angular-web-storage';

@Component({
  selector: 'app-qr-zoo-booking',
  templateUrl: './qr-zoo-booking.component.html',
  styleUrls: ['./qr-zoo-booking.component.scss'],
  providers: [TranslatePipe]
})
export class QRZooBookingComponent implements OnInit {
  ...
  */
   ...
   * Minimum start date.
  */
   startMinDate: Date = moment(new Date()).add(0, 'day').toDate();
  ...
  */
  ...
  ngOnInit() {
    ...
    this.selectedAtt = 'WITH_WALK_IN_AVIARY';
  ...
  this.suburl ="localhost:";

  if(this.fullurl.includes(this.suburl)){  
    this.username = "barad@gmail.com";
    this.password = "barad";
  }else{
    this.username = "prashantahirrao007@gmail.com";
    this.password = "P@2345!";
  }
  ...
  */
  ...
  setDefaultDate(){
    ...
    var defaultDate  = moment(new Date()).add(0, 'day').toDate();
    //alert(defaultDate);
  ...
  */
  ...
  setVisitorsType(){
    ...
    //alert(this.ticketBookingForm.get('typeOfTicket').get('code').value);
